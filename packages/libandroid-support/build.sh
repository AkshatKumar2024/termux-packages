TERMUX_PKG_HOMEPAGE=https://github.com/AkshatKumar2024/libandroid-support
...
TERMUX_PKG_SRCURL=(https://github.com/AkshatKumar2024/libandroid-support/archive/v${TERMUX_PKG_VERSION[0]}.tar.gz
                   https://github.com/AkshatKumar2024/wcwidth/archive/v${TERMUX_PKG_VERSION[1]}.tar.gz)
